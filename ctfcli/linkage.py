...
class SandBoxyCTFdLinkage():
	...
	def verify_masterlist(self):
		'''
		Computes/compares a hash value against several stored hash values in multiple locations
		The reason for multiple locations is to verify the stored hash itself
		'''
